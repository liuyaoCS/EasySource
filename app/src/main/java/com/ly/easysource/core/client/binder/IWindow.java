 ...
 */
package com.ly.easysource.core.client.binder;
/**
...
/**
     ...
     */
@Override public void executeCommand(String command, String parameters, android.os.ParcelFileDescriptor descriptor) throws android.os.RemoteException
{
...
@Override public void dispatchWallpaperCommand(String action, int x, int y, int z, android.os.Bundle extras, boolean sync) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     * specified file descriptor.
     */
public void executeCommand(String command, String parameters, android.os.ParcelFileDescriptor descriptor) throws android.os.RemoteException;
...
public void dispatchWallpaperCommand(String action, int x, int y, int z, android.os.Bundle extras, boolean sync) throws android.os.RemoteException;
/**
     * Drag/drop events
     */
