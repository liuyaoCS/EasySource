...
@Override public android.os.Bundle sendWallpaperCommand(android.os.IBinder window, String action, int x, int y, int z, android.os.Bundle extras, boolean sync) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public android.os.Bundle sendWallpaperCommand(android.os.IBinder window, String action, int x, int y, int z, android.os.Bundle extras, boolean sync) throws android.os.RemoteException;
