 ...
 */
package com.ly.easysource.components.receiver.binder;
/**
...
@Override public void performReceive(android.content.Intent intent, int resultCode, String data, android.os.Bundle extras, boolean ordered, boolean sticky, int sendingUser) throws android.os.RemoteException
{
...
public void performReceive(android.content.Intent intent, int resultCode, String data, android.os.Bundle extras, boolean ordered, boolean sticky, int sendingUser) throws android.os.RemoteException;
}
